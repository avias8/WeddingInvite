-- DropForeignKey
ALTER TABLE "Guest" DROP CONSTRAINT "Guest_invitee_id_fkey";

-- DropForeignKey
ALTER TABLE "SeatingAssignment" DROP CONSTRAINT "SeatingAssignment_guest_id_fkey";

-- DropForeignKey
ALTER TABLE "SeatingAssignment" DROP CONSTRAINT "SeatingAssignment_table_id_fkey";
...
-- AddForeignKey
ALTER TABLE "SeatingAssignment" ADD CONSTRAINT "SeatingAssignment_guest_id_fkey" FOREIGN KEY ("guest_id") REFERENCES "Guest"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "SeatingAssignment" ADD CONSTRAINT "SeatingAssignment_table_id_fkey" FOREIGN KEY ("table_id") REFERENCES "Table"("id") ON DELETE CASCADE ON UPDATE CASCADE;
