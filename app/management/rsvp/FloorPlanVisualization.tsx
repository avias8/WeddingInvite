...
const TABLE_LAYOUTS: TableLayout[] = [
    ...
    { id: 7, name: "Table 6", displayName: "6", x: 820, y: 950, width: 50, height: 150, capacity: 9, owner: "Shakthi" },
    { id: 14, name: "Table 11", displayName: "11", x: 680, y: 150, width: 50, height: 150, capacity: 9, owner: "Shakthi" },
    { id: 13, name: "Table 10", displayName: "10", x: 680, y: 300, width: 50, height: 150, capacity: 8, owner: "Shakthi" },
    { id: 12, name: "Table 9", displayName: "9", x: 680, y: 450, width: 50, height: 150, capacity: 8, owner: "Shakthi" },
    { id: 11, name: "Table 8", displayName: "8", x: 680, y: 650, width: 50, height: 150, capacity: 8, owner: "Shakthi" },
    { id: 10, name: "Table 7", displayName: "7", x: 680, y: 800, width: 50, height: 150, capacity: 9, owner: "Shakthi" },
    ...
    { id: 19, name: "Table 16", displayName: "16", x: 400, y: 850, width: 50, height: 150, capacity: 9, owner: "Avi" },
    { id: 27, name: "Table 24", displayName: "24", x: 220, y: 150, width: 50, height: 150, capacity: 9, owner: "Avi" },
    { id: 26, name: "Table 23", displayName: "23", x: 220, y: 300, width: 50, height: 150, capacity: 8, owner: "Avi" },
    { id: 25, name: "Table 22", displayName: "22", x: 220, y: 450, width: 50, height: 150, capacity: 8, owner: "Avi" },
    { id: 24, name: "Table 21", displayName: "21", x: 220, y: 650, width: 50, height: 150, capacity: 9, owner: "Avi" },
    { id: 23, name: "Table 20", displayName: "20", x: 220, y: 800, width: 50, height: 150, capacity: 9, owner: "Avi" },
];
