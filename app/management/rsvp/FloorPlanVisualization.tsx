...
const TABLE_LAYOUTS: TableLayout[] = [
    ...
    { id: 10, name: "Table 9", displayName: "9", x: 680, y: 800, width: 50, height: 150, capacity: 9, owner: "Shakthi" },
    ...
    { id: 22, name: "Table 21", displayName: "21", x: 400, y: 400, width: 50, height: 150, capacity: 9, owner: "Avi" },
    ...
    { id: 26, name: "Table 25", displayName: "25", x: 220, y: 300, width: 50, height: 150, capacity: 8, owner: "Avi" },
